...
function getConfig(): Config {
  ...
  if(saved.presenceState&&(/B[ÊE]TA/i.test(saved.presenceState)||/^Version 2\.(?:0|1(?:\.[1-5])?|2\.[0-2]) • OFFICIEL$/.test(saved.presenceState)))saved.presenceState='Version 2.2.3 • OFFICIEL';
  return {
    ...defaults,
    ...saved,
