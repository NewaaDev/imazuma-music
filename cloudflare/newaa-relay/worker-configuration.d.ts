/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4ddddcedb217d5a27d5ab5a237c41c77)
// Runtime types generated with workerd@1.20260820.1 2026-08-21 nodejs_compat
interface __BaseEnv_Env {
	ACCESS_TOKEN: string;
	YOUTUBE_API_KEY: string;
	MUSIC_ROOM: DurableObjectNamespace<import("./src/index").MusicRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MusicRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_TOKEN" | "YOUTUBE_API_KEY">> {}
}
